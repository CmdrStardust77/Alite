...
public class DefaultCoordinateTransformer implements ICoordinateTransformer {
	...
	public DefaultCoordinateTransformer(Alite alite) {
        ...
        AliteLog.d("DefaultCoordinateTransformer", "Width x Height == " + visibleArea.width() + " x " + visibleArea.height());
		if (visibleArea.width() == 1920 && visibleArea.height() == 1080 && visibleArea.left == 0 && visibleArea.top == 0) {
            ...
            AliteLog.d("DCT", "Offset X: " + offsetX + ", Offset Y: " + offsetY + ", Ratio: " + ratio);
		}
	}
